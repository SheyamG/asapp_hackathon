...
CHROMA_PATH = "chroma"
DATA_PATH = "N:\Sheyam\Chatbot-Final-Iteration\data"  # Ensure this path is correct

def main():
    # Argument for selecting the model
    parser = argparse.ArgumentParser()
    parser.add_argument("--reset", action="store_true", help="Reset the database.")
    parser.add_argument("--model", type=str, required=True, help="Model name for embeddings.")
